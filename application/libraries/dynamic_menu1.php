...
//	$otori = $this->session->userdata('pcOtoriName');
	...
	$sq = "SELECT  a.id, a.title,  a.link_type,  a.page_id,  a.module_name,  a.url,  a.uri,  a.dyn_group_id,  a.position,  a.target,  a.parent_id,  a.is_parent,  b.akses AS show_menu FROM dyn_menu a JOIN otori b ON a.id=b.menu_id WHERE b.user_id=$otori ORDER BY a.id "; 
	//echo $sq;
