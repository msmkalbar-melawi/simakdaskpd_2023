<div id="content">
	...
	<?php echo form_open('master/edit_urusan/'.$urusan->kd_urusan, array('class' => 'basic')); ?>
    <table class="form">
        <tr>
            <td><label>Kode Fungsi</label><br />
             <?php
                ...
                foreach($kdfungsi as $ckdfungsi){                    
                    if ($ckdfungsi->kd_fungsi==$urusan->kd_fungsi){
                            $lctam1 = $lctam1."<option value=\"$ckdfungsi->kd_fungsi\" selected >$ckdfungsi->kd_fungsi | $ckdfungsi->nm_fungsi </option>";                    
                    }else{ 
    	...
    	<tr>
        	<td><label>Kd_urusan</label><br /><input name="kd_urusan" type="text" id="kd_urusan" value="<?php echo $urusan->kd_urusan; ?>" size="10" /> <?php echo form_error('kd_urusan'); ?>
            </td>
        </tr>
        <tr>
            <td><label>Nm_urusan</label><br />
            <input name="nm_urusan" type="text" id="nm_urusan" value="<?php echo $urusan->nm_urusan; ?>" size="40" />
            <?php echo form_error('nm_urusan'); ?>
            </td>
        </tr>
        <tr>
