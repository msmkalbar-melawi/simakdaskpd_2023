		...
		<tr>
                 ...
                 <td>
                     ...
                     <select name="bidang" id="bidang">
						 <option value="1" <?php if($user->bidang == '1'){echo("selected");}?>>ANGGARAN</option>
                         <option value="2" <?php if($user->bidang == '2'){echo("selected");}?> >PERBENDAHARAAN</option>
						 <option value="3" <?php if($user->bidang == '3'){echo("selected");}?>>AKUTANSI</option>
                         <option value="4" <?php if($user->bidang == '4'){echo("selected");}?>>RENJA</option>
                         <option value="5" <?php if($user->bidang == '5'){echo("selected");}?>>PENATAUSAHAAN</option>
						 <option value="6" <?php if($user->bidang == '6'){echo("selected");}?>>PPK</option>
                     </select>
					 <?php echo form_error('type'); ?>
                 </td>        
		</tr>
