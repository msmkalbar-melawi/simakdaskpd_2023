<div id="content">
	...
	<?php echo form_open('master/edit_program/'.$program->kd_program, array('class' => 'basic')); ?>
    <table class="form">
    	<tr>
        	<td><label>Kd_Program</label><br /><input name="kd_program" type="text" id="kd_program" value="<?php echo $program->kd_program; ?>" size="10" /> <?php echo form_error('kd_program'); ?>
            </td>
        </tr>
        <tr>
            <td><label>Nm_Program</label><br />
            <input name="nm_program" type="text" id="nm_program" value="<?php echo $program->nm_program; ?>" size="40" />
