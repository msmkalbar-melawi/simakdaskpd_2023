...
<head>
    ...
    function addText() {
      var x = document.getElementById("kd_rek1");
      var y = document.getElementById("kd_rek2");
      getCmb = x.value;
      y.value = getCmb;
    }
...
<div id="content">
	...
	<?php echo form_open('master/tambah_rek2', array('class' => 'basic')); ?>
    <table class="form">
        <tr>
         <td><label>Kode Rekening Akun</label><br />
            
            <?php
                $lctam = '<select name="kd_rek1"id="kd_rek1" onchange="javascript: addText();">';
                $lctam1 = '';
    	...
    	<tr>
        	<td><label>Kode Rekening Kelompok </label><br /><input name="kd_rek2" type="text" id="kd_rek2" value="<?php echo set_value('kd_rek2'); ?>" size="10" /> <?php echo form_error('kd_rek2'); ?>
            </td>
        </tr>
        <tr>
            <td><label>Nama Rekening Kelompok </label><br />
            <input name="nm_rek2" type="text" id="nm_rek2" value="<?php echo set_value('nm_rek2'); ?>" size="60" />
            <?php echo form_error('nm_rek2'); ?>
            </td>
        </tr>
        <tr>
