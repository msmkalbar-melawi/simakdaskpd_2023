...
if (confirm("Anda yakin ingin menghapus data ini ?")) 
	...
	<div id="content">        
    	<h1><?php echo $page_title; ?>&nbsp;&nbsp;&nbsp;&nbsp; <a href="<?php echo site_url(); ?>/master/tambah_skpd"><img src="<?php echo base_url(); ?>assets/images/icon/add.jpg" width="25" height="23" title="Tambah Data"/></a>
        <img src="<?php echo base_url(); ?>assets/images/icon/print_pdf.png" width="25" height="23" title="Cetak Pdf"
        onclick="PopupCenter('<?php echo site_url(); ?>/master/preview_skpd', 'myPop1',900,800);"/> </h1>
        <?php echo form_open('master/cari_skpd', array('class' => 'basic')); ?>
        ...
        <table class="narrow">
            ...
            <tr>
                ...
                <td><a href="<?php echo site_url(); ?>/master/edit_skpd/<?php echo $skpd->kd_skpd; ?>" title="Edit"><img src="<?php echo base_url(); ?>assets/images/icon/edit.png" /></a>&nbsp;&nbsp;<a href="<?php echo site_url(); ?>/master/hapus_skpd/<?php echo $skpd->kd_skpd; ?>" title="Hapus"><img src="<?php echo base_url(); ?>assets/images/icon/cross.png" /></a></td>
            </tr>
            <?php endforeach; ?>
        </table>
