   ...
   function simpan_validasicms(){
                        ...
                        if (!($asg)){
                            ...
                            $asg = $this->db->query($sql);
                                ...
                                echo json_encode($msg);                     
                                    ...
                                    $sql = "INSERT INTO trdtransout (no_bukti, no_sp2d, kd_sub_kegiatan, nm_sub_kegiatan, kd_rek6, nm_rek6, nilai, kd_skpd,kunci, sumber)
                                        ...
                                        $sql = "INSERT INTO trhtrmpot (no_bukti, tgl_bukti, ket, username, tgl_update, kd_skpd, nm_skpd, no_sp2d, nilai, npwp, jns_spp, 
                                            ...
                                            if (!($asg)){
                                                ...
                                                echo json_encode($msg);                     
                                                    ...
                                                    $sql = "INSERT INTO trdtrmpot (no_bukti, kd_rek6, nm_rek6, nilai, kd_skpd, kd_rek_trans,ebilling,rekanan,npwp)
    ...
    function batal_validasicms(){
		...
		$prv = $this->db->query("SELECT COUNT(*) tot_lpj, 
								(SELECT DISTINCT CASE WHEN MONTH(a.tgl_bukti)<='$spjbulan' THEN 1 ELSE 0 END FROM trhtransout a WHERE  a.panjar = '0' AND a.kd_skpd='$skpd' AND a.no_bukti='$nbku') tot_spj 
