                        ...
                        if (!($asg)){
                            ...
                            $asg = $this->db->query($sql);
                                ...
                                echo json_encode($msg);                     
                                    ...
                                    $sql = "INSERT INTO trdtransout (no_bukti, no_sp2d, kd_kegiatan, nm_kegiatan, kd_rek5, nm_rek5, nilai, kd_skpd, nil_pad, nil_dak, nil_dau, nil_dbhp, nil_daknf, nil_did, sumber)
