...
class Lamp_perda extends CI_Controller
{
	...
	$sqlsc="SELECT nama,jabatan,pangkat FROM ms_ttd where nip='$ttd' AND kode IN ('PA','KPA')";
	...
	$sumber_data= "";
        ...
        $daerah      = $this->tukd_model->get_nama($kd_skpd,'daerah','sclient','kd_skpd');
...
//'.$this->tukd_model->rp_minus($sel).'
					...
					$sql="SELECT kd_kegiatan,kd_rek,nm_rek,anggaran,sd_bulan_ini FROM realisasi_jurnal_rinci_n$sumber_data($bulan,$anggaran,$lntahunang) $where $where1 
	...
	$sumber_data= "";
		...
		if ($kd_skpd=='1.20.03'){                               
            ...
            $where= "WHERE kd_org=LEFT('$kd_skpd',7)";
        }
