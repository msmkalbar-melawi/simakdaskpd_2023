...
class Rka_penetapan extends CI_Controller
{
    ...
    function tambah_rka_penetapan_sumber()
    {
        $jk   = $this->rka_model->combo_skpd();
        $ry   =  $this->rka_model->combo_giat();
        $cRet = '';
        ...
        $this->template->load('template', 'anggaran/rka/penetapan/tambah_rka_penetapan_sumber', $data);
        $query1->free_result();
    }
...
,a.nilai_sumber3,a.nilai_sumber4
    ...
    {
        $skpd     =  $this->input->post('kdskpd');
        $sql = "SELECT a.kd_skpd as kd_skpd,b.status as status, a.nm_skpd as nm_skpd , b.jns_ang as jns_ang FROM ms_skpd a LEFT JOIN trhrka b
                    ON a.kd_skpd=b.kd_skpd WHERE a.kd_skpd = '$skpd' and 
                    tgl_dpa in(SELECT  MAX(tgl_dpa) from trhrka where kd_skpd=a.kd_skpd AND status='1')";
        $query1 = $this->db->query($sql);
    ...
    function config_angkas()
    {
        $skpd     =  $this->input->post('kdskpd');
        $sql = "SELECT * From status_angkas WHERE kd_skpd = '$skpd' ";
        $query1 = $this->db->query($sql);
    ...
    function update_sdana_penetapan()
    {
    ...
    // ---------------- hakam ----------------------------------------
    function statusanggaran()
    {
        $skpd = $this->session->userdata('kdskpd');
        $sql = $this->db->query("SELECT kode, nama FROM tb_status_anggaran WHERE status_aktif='1'");
        $result = array();
        $ii = 0;
    ...
    function statusangkas()
    {
        $skpd = $this->session->userdata('kdskpd');
        $sql = $this->db->query("SELECT kode, nama FROM tb_status_angkas WHERE status='1'");
        $result = array();
        $ii = 0;
        foreach ($sql->result_array() as $resulte) {
            $result[] = array(
    ...
    GROUP BY a.kd_rek3, a.nm_rek3 ORDER BY kd_rek";
        ...
        $surplus = $cob1 - $cob;
        $cRet    .= " <tr>                                     
                                         <td colspan=\"2\" style=\"vertical-align:top;border-top: solid 1px black;border-bottom: none;\" align=\"right\" width=\"80%\">Surplus/Defisit</td>
                                         <td style=\"vertical-align:top;border-top: solid 1px black;border-bottom: none;\" width=\"20%\" align=\"right\">" . $this->rka_model->angka($surplus) . "</td></tr>";
    ...
    GROUP BY a.kd_rek3, a.nm_rek3 ORDER BY kd_rek";
        ...
        $pnetto = $cobtpm - $cobtpk;
        $cRet    .= " <tr>                                     
                                         <td colspan=\"2\" style=\"vertical-align:top;border-top: solid 1px black;border-bottom: none;\" align=\"right\" width=\"80%\">Pembiayaan Netto</td>
                                         <td style=\"vertical-align:top;border-top: solid 1px black;border-bottom: none;\" width=\"20%\" align=\"right\">" . $this->rka_model->angka($pnetto) . "</td>
                                         </tr></table>";
    ...
    function select_rka($kegiatan = '', $skpd = '')
    {
        $sql = "SELECT a.kd_rek6,b.nm_rek6,a.nilai,a.nilai_sempurna,a.nilai_ubah,a.sumber,a.sumber2,a.sumber3,a.sumber4,a.nilai_sumber,a.nilai_sumber2
                    ...
                    where a.kd_sub_kegiatan='$kegiatan'  and a.kd_skpd='$skpd' and left(a.kd_rek6,3) 
