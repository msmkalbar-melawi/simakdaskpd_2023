...
class SP3BBludController extends CI_Controller
{
    ...
    function index()
    {
        ...
        $this->template->load('template','/blud/sp3b/index',$data) ; 
    }
    ...
    function cetak_sp3b_blud(){
        $margin = 15;
        $lcskpd = $this->input->get('skpd');
        $ctgl_1 = $this->input->get('tanggalAwal');
        $ctgl_2 = $this->input->get('tanggalAkhir');
        $no_sp3b = $this->input->get('nosp3b');
        $ctk = $this->input->get('cetak');
        //$nip2 = $this->input->get()
        //$ctk = $this->input->get()
       // $no_sp3b = $this->uri->segment(12);
        //$ctk    = $this->uri->segment(7);
        $nip2 = str_replace('123456789',' ',$this->input->get('ttd'));
        $ketsaldo = ''; 
        $tanggal_ttd = $this->tukd_model->tanggal_format_indonesia($this->input->get('ctglttd'));
        $atas = $margin;
        $bawah = $margin;
        $kiri = $margin;
        $kanan = $margin;  
        ...
        $sqlttd1=$this->db->query("SELECT nama, nip, jabatan,pangkat FROM ms_ttd where nip='$nip2'")->row();
        $nip=$sqlttd1->nip;                    
        $nama= $sqlttd1->nama;
        $jabatan  = $sqlttd1->jabatan;
        $pangkat  = $sqlttd1->pangkat;
            ...
            $cRet ='<TABLE style="border-collapse:collapse; font-size:14px" width="100%" border="1" cellspacing="0" cellpadding="1" align=center>
                    <TR>
                        <TD align="center" ><b>'.$prov.' <br>
                                            ...
                                            Tanggal : '.$this->tukd_model->tanggal_format_indonesia($tglsp3b).' &nbsp;&nbsp; Nomor : '.$no_sp3b.'                                                 
                        </TD>
                    </TR>                   
                    </TABLE>';          
            $cRet .='<TABLE style="border-collapse:collapse; border-top:none; border-left:solid 1px black; border-right:solid 1px black; border-bottom:solid 1px black; font-size:13px;" width="100%">
                    <TR>
                        <TD align="left" >Kepala SKPD RSUD Melawi memohon kepada : </TD>                     
                    </TR>                   
                    </TABLE>';
            $cRet .='<TABLE style="border-collapse:collapse; border-top:none; border-left:solid 1px black; border-right:solid 1px black; border-bottom:solid 1px black; font-size:13px;" width="100%">
                    <TR>
    ...
    $sqlxx="SELECT sum(isnull(c.terima,0)) terima,sum(isnull(c.keluar,0)) keluar from(
            ...
            $cRet .='<TABLE style="border-collapse:collapse; border-top:none; border-left:solid 1px black; border-right:solid 1px black; border-bottom:solid 1px black; font-size:13px;" width="100%">
                    <TR>
                        <TD align="center" colspan="3" width="50%" style="border-collapse:collapse; border-right:solid 1px black;"><b>PENDAPATAN</b></TD>                       
    ...
    order by kd_pen desc
            ...
            $cRet .='<TR>
                        ...
                        <TD align="right" style="border-collapse:collapse; border-top:solid 1px black; border-left:solid 1px black; border-right:solid 1px black; border-bottom:solid 1px black;" width="15%">
                        <b>'.number_format($jum_bel4 ,'2',',','.').'</b>
                        </TD>
                        <TD align="center" colspan="2" style="border-collapse:collapse; border-top:solid 1px black; border-left:solid 1px black; border-right:solid 1px black; border-bottom:solid 1px black;" width="35%">
                        <b>Jumlah Belanja</b>
                        </TD>                       
                        <TD align="right" style="border-collapse:collapse; border-top:solid 1px black; border-left:solid 1px black; border-right:solid 1px black; border-bottom:solid 1px black;" width="15%">
                        <b>'.number_format($jum_bel5,'2',',','.').'</b>
                        </TD>
                    </TR></TABLE>';         
            ...
            $cRet .='<TABLE style="font-size:13px;" width="100%" align="center">
                    ...
                    <TR>
                        <TD width="50%" align="center" ></TD>
                        <TD width="50%" align="center" >Direktur <br> RSUD Melawi</TD>
                    </TR>
                    <TR>
